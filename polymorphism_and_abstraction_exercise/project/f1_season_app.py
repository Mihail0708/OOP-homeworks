...
class F1SeasonApp:
    ...
    def new_race_results(self, race_name, red_bull_pos, mercedes_pos):
        ...
        redbull_rev = self.red_bull_team.calculate_revenue_after_race(red_bull_pos)
        mercedes_rev = self.mercedes_team.calculate_revenue_after_race(mercedes_pos)

        return f"Red Bull: {redbull_rev}. Mercedes: {mercedes_rev}. {ahead_team} is ahead at the {race_name} race."
